...
CUSTOM_HAL_IMGSENSOR = s5k3p3sx_mipi_raw_kmj s5k3p3sx_mipi_raw imx135_mipi_raw gc8034_mipi_raw gc8024_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_LENS = dw9763afkmj dw9763af dw9718af dw9714af dummy_lens  
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9718af dw9714af
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw_kmj s5k3p3sx_mipi_raw imx135_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_MAIN_LENS = dw9763afkmj dw9763af dw9718af dw9714af  
...
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw gc8024_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3p3sx_mipi_raw_kmj s5k3p3sx_mipi_raw imx135_mipi_raw gc8034_mipi_raw gc8024_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9763afkmj dw9763af dw9718af dw9714af dummy_lens  
CUSTOM_KERNEL_MAGNETOMETER = no
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9718af dw9714af 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw_kmj s5k3p3sx_mipi_raw imx135_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_MAIN_LENS = dw9763afkmj dw9763af dw9718af dw9714af  
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8034_mipi_raw gc8024_mipi_raw
...
CUSTOM_MODEM= s590_TK_MD_BASIC-lwctg_mp5_6750-gsm4p_w_1_8_fdd_1_3_7_8_20_airoha
...
#cts testLiveWallpaperFeature fail
...
#close by chenxin for build error
MTK_WAPI_SUPPORT = no
...
HCT_SUPPORT_FINGERPRINT_CHIP = microarray_tee_back
...
#分支信息
HCT_BUILD_PRODUCT_NAME = s590ak-p20-fhdp-512g32g-Discrete-O0-bom11
HCT_LOCALIZATION_OVERLAY = zh-rCN
HCT_PRODUCT_MODEL = CUBOT_P20
HCT_PRODUCT_BRAND = CUBOT
HCT_PRODUCT_MANUFACTURER = CUBOT
HCT_LCD_RESOULTION_SIZE = FHDP
HCT_CQ8021_SYSTEM_PROP = yes
HCT_SUPPORT_NOTCH_SCREEN = yes
HCT_SIMID_FIXED_SUPPORT = yes

#去掉来电归属地
HCT_NEED_NUMBER_GEO_SUPPORT = yes
...
#版本号
CUSTOM_BUILD_VERNO = CUBOT_P20_8023C_V16_20190326
MTK_BUILD_VERNO = CUBOT_P20_8023C_V16_20190326

#Launcher相关
HCT_SINGELSCREEN_WALLPAPER = yes
HCT_LAUNCHER_SUPPORT_CHINESE_SEARCH = yes
#增加更多铃声
...
#GMS认证
HCT_GOOGLE_CLIENTIDBASE = android-cubot
#fastpass + 
HCT_FASTPASS_SUPPORT = yes
#GMS包
HCT_MODIFY_FOR_CTS = yes
HCT_GOOGLE_GMS_R7 = yes
HCT_PACKAGES_SUBSTITUTE = GoogleHome:- GoogleCamera:- DeskClockGoogle:- Bugle:- EditorsDocs:- EditorsSheets:- EditorsSlides:- NewsWeather:- TagGoogle:- Keep:- DMAgent:- GoogleEars:- GoogleEarth:- GoogleHindiIME:- GooglePinyinIME:- KoreanIME:- Wallet:- JapaneseIME:- AndroidPay:- BookmarkProvider:- QuickSearchBox:- GmsSampleLayout:- Hangouts:- CarrierServices:- GoogleContacts:- GoogleDialer:- CalculatorGoogle:- FaceLock:- LatinImeGoogle:- OobConfig:- GmsSampleIntegration:-
